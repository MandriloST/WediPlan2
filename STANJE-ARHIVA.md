# STANJE-ARHIVA.md — arhiva dnevnika rada (starije sesije)

> Ovo je ARHIVA. Aktualno stanje, pravila i zadnje sesije su u `STANJE.md` (to je obavezno štivo
> prije koda). Ovdje su detalji starijih sesija radi povijesti/reference — NE treba ih čitati
> rutinski. Novije sesije na vrhu (kao i u STANJE.md).
